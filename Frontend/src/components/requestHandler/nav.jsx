    ...
    return (
        <nav className="bg-[var(--primary-600)] text-white px-4 py-3 flex justify-between items-center shadow-md relative">
          ...
          transition-colors duration-200">
            ...
            <div id="drawer" className="absolute top-full right-0 w-55 bg-white text-[var(--primary-600)] shadow-md rounded-md mt-1 p-2 hidden flex-col gap-2 z-50">
                <a href="/timetable/admin">
