  ...
  return (
    <form className='flex justify-center content-center py-10 rounded-2xl max-h-[700px] overflow-auto' onSubmit={handleSubmit}>
      ...
      <div>
        ...
        <select id="timeEdit" name="time" className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-[var(--primary-500)] focus:ring-opacity-50 transition duration-200" value={data.time} onChange={handleChange}>
